      ...
      sets: {
        u1p1: {
          ...
          words: [
            ...
            { en: "join", ja: "～に加わる、参加する", kana: "ジョイン", dj: ["～に感謝する", "Aを上下さかさまにする", "演ずる、披露する", "～に参加する"], de: ["just", "JHS", "love", "call"] },
        ...
        u1p2: {
          ...
          words: [
            ...
            { en: "but", ja: "しかし", kana: "バット", dj: ["いいえ", "ファン", "友達", "ラグビー"], de: ["bud", "bird", "fan", "art"] },
            { en: "rugby", ja: "ラグビー", kana: "ラグビー", dj: ["いいえ", "ファン", "しかし", "友達"], de: ["reach", "read", "really", "sunny"] },
        ...
        s105gdqs: {
          ...
          words: [
            ...
            { en: "he's", ja: "he isの短縮形", kana: "ヒーズ", dj: ["she isの短縮形", "it isの短縮形", "I amの短縮形", "do notの短縮形"], de: ["hear", "she's", "heavy", "HS"] },
            ...
            { en: "be good at ~ing", ja: "～することが得意だ", kana: "ビー グッド アット イング", dj: ["アメリカ(合衆国)", "～の一員で", "チーム", "（男性をさして）～さん、～先生"], de: ["be going to ~", "be ready to ~", "be able to ~", "be dropped on 〜"] },
        ...
        s105gdqt: {
          ...
          words: [
            ...
            { en: "read", ja: "読む", kana: "リード", dj: ["中国", "親", "食べ物", "父"], de: ["reach", "really", "recipe", "team"] },
            ...
            { en: "father", ja: "父", kana: "ファーザァ", dj: ["親", "読む", "中国", "食べ物"], de: ["fan", "weather", "food", "teacher"] },
            ...
            { en: "really", ja: "本当に、本当ですか", kana: "リーアリィ", dj: ["～することができる", "じょうずに", "そのこと", "食べ物"], de: ["read", "reach", "recipe", "reflect"] },
        ...
        s105gdqu: {
          ...
          words: [
            ...
            { en: "bird", ja: "鳥", kana: "バード", dj: ["おっと", "それ[が]", "歓迎される", "今"], de: ["bud", "but", "behind", "hard"] },
            ...
            { en: "Thank you.", ja: "ありがとう。", kana: "サンキュー", dj: ["すみません。", "はい、どうぞ。", "どういたしまして。", "なるほど。"], de: ["thank", "that", "that's", "through"] },
      ...
      sets: {
        u1p1: {
          ...
          words: [
            ...
            { en: "heavy", ja: "重い", kana: "ヘビー", dj: ["お互い", "痛い", "～したい", "～でない"], de: ["hear", "health", "he's", "hard"] },
            { en: "cloudy", ja: "曇りの", kana: "クラウディ", dj: ["日本の", "英語の", "中国の", "可能な"], de: ["closely", "club", "class", "clear"] },
            { en: "reach", ja: "（目標に）手が届く", kana: "リーチ", dj: ["ステップ、段階", "ネットで、オンラインで", "摂氏～度（℃）", "ウェブサイト、ホームページ"], de: ["read", "really", "recipe", "reflect"] },
        ...
        u1p2: {
          ...
          words: [
            ...
            { en: "hand in ~", ja: "～を提出する", kana: "ハンド イン", dj: ["～を移動する", "～を招待する", "～を紹介する", "～を計画する"], de: ["He is ~.", "want to ~", "hear of 〜", "haven't"] },
        ...
        u1p3: {
          ...
          words: [
            ...
            { en: "health", ja: "健康", kana: "ヘルス", dj: ["歴史", "レシピ、調理法", "情報", "天気"], de: ["hear", "heavy", "half", "he's"] },
        ...
        u1rt: {
          ...
          words: [
            { en: "hear", ja: "～ということを耳にする、～だそうだ", kana: "ヒア", dj: ["（クラスなどの）総代", "AをBとともに終える", "ミーティング、会議", "～する準備が整う"], de: ["heavy", "health", "he's", "hard"] },
            { en: "meeting", ja: "ミーティング、会議", kana: "ミーティング", dj: ["～する準備が整う", "（クラスなどの）総代", "ミラー[人の姓]", "AをBとともに終える"], de: ["me", "ceiling", "behind", "memorial"] },
            { en: "through", ja: "～を通して、～によって", kana: "スルー", dj: ["～を楽しみにする", "～を計画する", "～を提案する", "～を決める"], de: ["they'll", "thousand", "that's", "thank"] },
            ...
            { en: "title", ja: "題、演目", kana: "タイトル", dj: ["～できる", "千（の）", "総計で", "初めて"], de: ["Miller", "take", "team", "that"] },
            ...
            { en: "decide", ja: "～を決める", kana: "ディサイド", dj: ["～を計画する", "～を提案する", "～を楽しみにする", "～を通して、～によって"], de: ["degree", "recipe", "dome", "excuse"] },
      ...
      sets: {
        r1: {
          ...
          words: [
            ...
            { en: "trick", ja: "〜をだます", kana: "トリック", dj: ["〜を片づける", "〜を荷造りする", "〜を集める", "〜を殺す"], de: ["pack", "thank", "take", "tragedy"] },
            ...
            { en: "mirror", ja: "鏡", kana: "ミラー", dj: ["ちょうど", "髪を切る", "じっくりと", "次回(に)"], de: ["Miller", "Mr.", "most", "Ms."] },
        ...
        r2: {
          ...
          words: [
            { en: "been", ja: "[beの過去分詞形]", kana: "ビーン", dj: ["眠る[原形-過去形]", "乗る[原形-過去形-過去分詞形]", "泳ぐ[原形-過去形-過去分詞形]", "行く[原形-過去形-過去分詞形]"], de: ["behind", "bird", "but", "bud"] },
            ...
            { en: "tent", ja: "テント", kana: "テント", dj: ["有名人", "今までに", "見てみる", "サーフィン"], de: ["team", "that", "end", "yet"] },
        ...
        r3: {
          ...
          words: [
            ...
            { en: "reflect", ja: "〜を映す、反射する", kana: "リフレクト", dj: ["〜を荷造りする", "〜を(次の世代へ)渡す", "〜を感動させる", "〜を切り抜けて生き残る"], de: ["really", "reach", "collect", "recipe"] },
        ...
        r4: {
          ...
          words: [
            ...
            { en: "Spanish", ja: "スペイン(人)の", kana: "スパニッシュ", dj: ["フランス(人)の", "可能な", "平らな", "破壊的な"], de: ["English", "Japanese", "French", "success"] },
            { en: "flat", ja: "平らな", kana: "フラット", dj: ["可能な", "スペイン(人)の", "フランス(人)の", "明白な"], de: ["fan", "that", "food", "French"] },
        ...
        r5: {
          ...
          words: [
            ...
            { en: "be into 〜", ja: "〜に熱中する", kana: "ビー イントゥ", dj: ["爆発する", "Aを上下さかさまにする", "～に感謝する", "～に参加する"], de: ["be going to ~", "be able to ~", "be ready to ~", "behind"] },
            { en: "move", ja: "〜を感動させる", kana: "ムーブ", dj: ["〜を傷つける", "〜をする前に", "〜を殺す", "〜を(次の世代へ)渡す"], de: ["most", "make", "move to 〜", "me"] },
            { en: "before 〜ing", ja: "〜をする前に", kana: "ビフォー", dj: ["〜を傷つける", "〜を感動させる", "〜を殺す", "〜を(次の世代へ)渡す"], de: ["be into 〜", "be able to ~", "be good at ~ing", "behind"] },
        ...
        r6: {
          ...
          words: [
            ...
            { en: "would", ja: "[willの過去形]", kana: "ウッド", dj: ["[beの過去分詞形]", "眠る[原形-過去形]", "来る[原形-過去形-過去分詞形]", "乗る[原形-過去形-過去分詞形]"], de: ["won't", "wow", "we'll", "well"] },
            ...
            { en: "recovery", ja: "回復", kana: "リカバリー", dj: ["けが", "30分", "向こうに", "人物の像"], de: ["recipe", "really", "reflect", "reach"] },
            ...
            { en: "figure", ja: "人物の像", kana: "フィギュア", dj: ["向こうに", "30分", "箱、ケース", "何千もの〜"], de: ["injury", "friend", "father", "food"] },
        ...
        r7: {
          ...
          words: [
            { en: "explode", ja: "爆発する", kana: "エクスプロード", dj: ["〜に熱中する", "Aを上下さかさまにする", "～に感謝する", "～に参加する"], de: ["excuse", "English", "everyone", "end"] },
            ...
            { en: "tragedy", ja: "悲劇", kana: "トラジェディ", dj: ["建物", "破壊", "爆撃", "生存者"], de: ["transplant", "trick", "teacher", "title"] },
            { en: "bud", ja: "芽", kana: "バッド", dj: ["力", "建物", "破壊", "悲劇"], de: ["but", "bird", "end", "been"] },
