      ...
      sets: {
        u1p1: {
          ...
          words: [
            ...
            { en: "love", ja: "～が大好きである", kana: "ラブ", dj: ["南アフリカ共和国", "呼ぶ、名づける", "クラブ、部", "私を（に）"], de: ["low", "lie", "lady", "move"] },
            ...
            { en: "join", ja: "～に加わる、参加する", kana: "ジョイン", dj: ["～に感謝する", "行進する、パレードする", "Aを上下さかさまにする", "演ずる、披露する"], de: ["just", "JHS", "love", "town"] },
            { en: "sweet", ja: "甘い菓子", kana: "スウィート", dj: ["～もまた", "みなさん", "クラブ、部", "私を（に）"], de: ["street", "step", "sunset", "she's"] },
        ...
        u1p2: {
          ...
          words: [
            ...
            { en: "watch", ja: "～を（注意して）見る", kana: "ウォッチ", dj: ["～を利用する、～を受ける", "～を作る", "～を許す", "～を通して、～によって"], de: ["waste", "war", "path", "pack"] },
            { en: "friend", ja: "友達", kana: "フレンド", dj: ["あら", "いいえ", "ファン", "しかし"], de: ["French", "fan", "forest", "food"] },
            ...
            { en: "great", ja: "すばらしい", kana: "グレート", dj: ["～でない", "かっこいい", "～したい", "かわいい"], de: ["ground", "good", "read", "area"] },
        ...
        u1p3: {
          ...
          words: [
            ...
            { en: "draw", ja: "（線や絵）をかく", kana: "ドロー", dj: ["（日本の）アニメ", "～に所属して", "芸術、美術", "～について"], de: ["dome", "pray", "art", "now"] },
            { en: "swimming", ja: "水泳", kana: "スイミング", dj: ["学校", "授業", "今", "マンガ"], de: ["surfing", "sweet", "someone", "skin"] },
            { en: "school", ja: "学校", kana: "スクール", dj: ["水泳", "授業", "今", "マンガ"], de: ["shoot", "so", "skill", "cool"] },
            { en: "art", ja: "芸術、美術", kana: "アート", dj: ["～について", "～に所属して", "マンガ", "だから"], de: ["area", "around", "anime", "about"] },
            { en: "a, an", ja: "１つの、1人の", kana: "ア、アン", dj: ["～から、～出身の", "あなた(たち)の", "いくつかの", "あれ、あの"], de: ["A and B", "anime", "in ~", "area"] },
            { en: "now", ja: "今", kana: "ナウ", dj: ["水泳", "学校", "授業", "マンガ"], de: ["no", "wow", "low", "so"] },
            { en: "in ~", ja: "～に所属して", kana: "イン", dj: ["芸術、美術", "～について", "（線や絵）をかく", "（日本の）アニメ"], de: ["into ~", "in total", "on ~", "injury"] },
            { en: "about ~", ja: "～について", kana: "アバウト", dj: ["芸術、美術", "～に所属して", "マンガ", "だから"], de: ["about", "above", "A and B", "absolutely"] },
            ...
            { en: "wow", ja: "うわあ", kana: "ワオ", dj: ["マンガ", "だから", "水泳", "学校"], de: ["now", "win", "war", "low"] },
          ],
        },
        s105gdqs: {
          label: "Unit2 Part1",
          words: [
            ...
            { en: "she's", ja: "she isの短縮形", kana: "シーズ", dj: ["he isの短縮形", "do notの短縮形", "cannotの短縮形", "you areの短縮形"], de: ["he's", "shoot", "She is ~.", "sweet"] },
            ...
            { en: "good", ja: "じょうずな、よい", kana: "グッド", dj: ["かっこいい", "かわいい", "～することができない", "すばらしい"], de: ["cool", "glow", "food", "great"] },
            { en: "English", ja: "英語の", kana: "イングリッシュ", dj: ["私たちの", "日本の", "中国の", "その"], de: ["end", "Spanish", "explode", "excuse"] },
            { en: "cute", ja: "かわいい", kana: "キュート", dj: ["かっこいい", "じょうずな、よい", "～したい", "～でない"], de: ["cool", "Cusco", "culture", "cafe"] },
            ...
            { en: "America", ja: "アメリカ(合衆国)", kana: "アメリカ", dj: ["～することが得意だ", "～の一員で", "チーム", "（男性をさして）～さん、～先生"], de: ["area", "anime", "art", "Mr."] },
          ],
        },
        s105gdqt: {
          label: "Unit2 Part2",
          words: [
            ...
            { en: "parent", ja: "親", kana: "ペアレント", dj: ["父", "読む", "中国", "食べ物"], de: ["partner", "parade", "print", "painter"] },
            ...
            { en: "very", ja: "非常に、[否定文で]あまり～でない", kana: "ヴェリィ", dj: ["～することができない", "じょうずな、よい", "すばらしい", "かっこいい"], de: ["read", "well", "Peru", "ever"] },
            ...
            { en: "I see.", ja: "なるほど。", kana: "アイ スィー", dj: ["すみません。", "ありがとう。", "はい、どうぞ。", "彼は[が]～です。"], de: ["itself", "into ~", "in ~", "He is ~."] },
          ],
        },
        s105gdqu: {
          label: "Unit2 Part3",
    ...
    g2: {
      ...
      sets: {
        u1p1: {
          ...
          words: [
            { en: "will", ja: "～するでしょう、～するつもりです", kana: "ウィル", dj: ["ウェブサイト、ホームページ", "ネットで、オンラインで", "（目標に）手が届く", "ステップ、段階"], de: ["win", "well", "we'd", "wow"] },
            ...
            { en: "forget-forgot", ja: "～を忘れる[原形-過去形]", kana: "フォーゲット・フォーゴット", dj: ["書く[原形-過去形]", "来る[原形-過去形-過去分詞形]", "[beの過去分詞形]", "乗る[原形-過去形-過去分詞形]"], de: ["forest", "firework", "follow", "food"] },
            { en: "send", ja: "～を送る", kana: "センド", dj: ["～を運ぶ", "～を移動する", "～を招待する", "～を決める"], de: ["serve", "step", "sunny", "we'd"] },
            { en: "carry", ja: "～を運ぶ", kana: "キャリー", dj: ["～を送る", "～を移動する", "～を招待する", "～を決める"], de: ["can't", "call", "cafe", "case"] },
            { en: "sunny", ja: "晴れた", kana: "サニー", dj: ["最低値", "最高値", "激しく", "情報"], de: ["sunset", "surfing", "study", "since"] },
            { en: "heavy", ja: "重い", kana: "ヘビー", dj: ["お互い", "力強い", "痛い", "～したい"], de: ["hear", "health", "he's", "hell"] },
            ...
            { en: "step", ja: "ステップ、段階", kana: "ステップ", dj: ["摂氏～度（℃）", "（目標に）手が届く", "申し込む", "晴れた"], de: ["study", "stage", "street", "send"] },
            ...
            { en: "high", ja: "最高値", kana: "ハイ", dj: ["晴れた", "最低値", "激しく", "情報"], de: ["hard", "hear", "hope", "half"] },
            { en: "weather", ja: "天気", kana: "ウェザー", dj: ["情報", "動画", "晴れた", "最低値"], de: ["website", "western", "teacher", "welcome"] },
            { en: "online", ja: "ネットで、オンラインで", kana: "オンライン", dj: ["（目標に）手が届く", "ウェブサイト、ホームページ", "ステップ、段階", "摂氏～度（℃）"], de: ["often", "on ~", "invite", "anime"] },
            { en: "hard", ja: "激しく", kana: "ハード", dj: ["晴れた", "最低値", "最高値", "情報"], de: ["half", "harvest", "high", "hear"] },
            { en: "we'd", ja: "we wouldの短縮形", kana: "ウィド", dj: ["will notの短縮形", "it willの短縮形", "I willの短縮形", "what areの短縮形"], de: ["we'll", "we've", "well", "won't"] },
            ...
            { en: "video clip", ja: "動画", kana: "ビデオ クリップ", dj: ["情報", "天気", "晴れた", "最低値"], de: ["victim", "sign up", "into ~", "move to 〜"] },
          ],
        },
        u1p2: {
          ...
          words: [
            ...
            { en: "partner", ja: "パートナー、相棒", kana: "パートナー", dj: ["～まで（ずっと）", "～するつもり", "スキル、腕前", "髪を切る"], de: ["parent", "parade", "painter", "path"] },
            { en: "take part in ~", ja: "～に参加する", kana: "テイク パート イン", dj: ["演ずる、披露する", "行進する、パレードする", "～に感謝する", "〜に熱中する"], de: ["take a look", "take", "take-took-taken", "hand in ~"] },
            ...
            { en: "until", ja: "～まで（ずっと）", kana: "アンティル", dj: ["パートナー、相棒", "～するつもり", "スキル、腕前", "髪を切る"], de: ["usage", "skill", "detail", "end"] },
        ...
        u1rt: {
          ...
          words: [
            ...
            { en: "for the first time", ja: "初めて", kana: "フォー ザ ファースト タイム", dj: ["総計で", "参加者", "～できる", "題、演目"], de: ["forest", "forget-forgot", "next time", "South Africa"] },
            { en: "plan", ja: "～を計画する", kana: "プラン", dj: ["～を提案する", "～を決める", "～を楽しみにする", "～を通して、～によって"], de: ["pray", "pack", "path", "Peru"] },
            ...
            { en: "interview", ja: "インタビュー", kana: "インタビュー", dj: ["～の後ろに", "舞台、ステージ", "聴衆、観客", "～する準備が整う"], de: ["introduce", "Inti Raymi", "invite", "into ~"] },
            ...
            { en: "decide", ja: "～を決める", kana: "ディサイド", dj: ["～を計画する", "～を提案する", "～を楽しみにする", "～を通して、～によって"], de: ["decrease", "degree", "detail", "destroy"] },
            ...
            { en: "audience", ja: "聴衆、観客", kana: "オーディエンス", dj: ["～の後ろに", "～できる", "題、演目", "千（の）"], de: ["ancient", "anime", "since", "America"] },
        ...
        sdgerro: {
          ...
          words: [
            { en: "win", ja: "（試合など）に勝つ", kana: "ウィン", dj: ["詳細、詳しい内容", "コンビニエンスストア", "ミュージシャン", "100万(の)"], de: ["will", "wow", "war", "well"] },
            { en: "hope", ja: "～だとよいと思う、～を望む", kana: "ホウプ", dj: ["発表、プレゼン(テーション)", "コンビニエンスストア", "（試合など）に勝つ", "詳細、詳しい内容"], de: ["rose", "high", "hard", "hear"] },
            ...
            { en: "about", ja: "約、おおよそ", kana: "アバウト", dj: ["競技会、大会", "点、小数点", "ミュージシャン", "100万(の)"], de: ["about ~", "above", "around", "art"] },
            ...
            { en: "human", ja: "人間、人", kana: "ヒューマン", dj: ["ランタン", "～など", "点、小数点", "通り"], de: ["human-shaped", "hear", "hope", "high"] },
            { en: "detail", ja: "詳細、詳しい内容", kana: "ディーテイル", dj: ["（試合など）に勝つ", "ミュージシャン", "100万(の)", "約、おおよそ"], de: ["degree", "decide", "destroy", "damage"] },
            { en: "competition", ja: "競技会、大会", kana: "コンペティション", dj: ["約、おおよそ", "点、小数点", "ミュージシャン", "100万(の)"], de: ["complete", "compose", "comic", "presentation"] },
            { en: "what're", ja: "what areの短縮形", kana: "ワター", dj: ["will notの短縮形", "we wouldの短縮形", "it willの短縮形", "we willの短縮形"], de: ["we've", "that's", "weather", "western"] },
            { en: "lantern", ja: "ランタン", kana: "ランタン", dj: ["人間、人", "～など", "点、小数点", "通り"], de: ["lately", "lady", "painter", "lighted"] },
            { en: "firework", ja: "花火", kana: "ファイアワーク", dj: ["通り", "バラ", "町", "駅"], de: ["figure", "forest", "mirror", "friend"] },
        ...
        sdgerrp: {
          ...
          words: [
            ...
            { en: "serve", ja: "（食事・飲み物を）出す", kana: "サーヴ", dj: ["リラックスする、くつろぐ", "～の中へ、～に向けて", "ピクニック", "小道、細道"], de: ["send", "stage", "since", "street"] },
            { en: "pray", ja: "祈る", kana: "プレイ", dj: ["地域", "日没", "祈り", "幸福"], de: ["prayer", "print", "path", "plan"] },
            { en: "river", ja: "川", kana: "リバー", dj: ["森", "竹", "祈る", "地域"], de: ["relax", "rose", "rule", "prayer"] },
            { en: "area", ja: "地域", kana: "エリア", dj: ["祈る", "日没", "祈り", "幸福"], de: ["art", "around", "appear", "read"] },
            ...
            { en: "glow", ja: "光り輝く", kana: "グロー", dj: ["浮かぶ", "ピクニック", "小道、細道", "カフェ"], de: ["low", "good", "now", "wow"] },
            { en: "float", ja: "浮かぶ", kana: "フロート", dj: ["カフェ", "完全に", "祈る", "地域"], de: ["flat", "flash", "food", "forest"] },
            { en: "waste", ja: "～を無駄にする", kana: "ウェイスト", dj: ["～を解放する", "～を移動する", "～を招待する", "～を提出する"], de: ["watch", "war", "western", "we've"] },
            { en: "sunset", ja: "日没", kana: "サンセット", dj: ["祈る", "地域", "祈り", "幸福"], de: ["sunny", "success", "suggest", "street"] },
            ...
            { en: "path", ja: "小道、細道", kana: "パス", dj: ["ピクニック", "光り輝く", "浮かぶ", "カフェ"], de: ["pack", "pray", "parent", "partner"] },
            { en: "happiness", ja: "幸福", kana: "ハピネス", dj: ["祈る", "地域", "日没", "祈り"], de: ["happen", "harvest", "haven't", "hasn't"] },
            { en: "forest", ja: "森", kana: "フォレスト", dj: ["川", "竹", "祈る", "地域"], de: ["follow", "food", "float", "friend"] },
            { en: "cafe", ja: "カフェ", kana: "キャフェイ", dj: ["浮かぶ", "完全に", "祈る", "地域"], de: ["case", "call", "can", "craft"] },
            { en: "bamboo", ja: "竹", kana: "バンブー", dj: ["川", "森", "祈る", "地域"], de: ["bombing", "behind", "Brazil", "bird"] },
            { en: "western", ja: "西方の", kana: "ウェスターン", dj: ["壮大な", "曇りの", "古代の", "不可能な"], de: ["weather", "waste", "website", "we've"] },
            { en: "magnificent", ja: "壮大な", kana: "マグニフィセント", dj: ["西方の", "曇りの", "古代の", "不可能な"], de: ["ancient", "make", "musician", "meaning"] },
        ...
        s1eufexn: {
          ...
          words: [
            ...
            { en: "lie", ja: "～に位置する、ある", kana: "ライ", dj: ["言い回し、フレーズ", "AにBを思い出させる", "～に従う、守る", "犠牲者、被災者"], de: ["low", "love", "lighted", "lady"] },
            ...
            { en: "impossible", ja: "不可能な", kana: "インポッスィブル", dj: ["大規模な、大きな", "さまざまな、多種多様の", "色とりどりの、色彩豊かな", "曇りの"], de: ["possible", "invite", "itself", "colorful"] },
            ...
            { en: "appear", ja: "現れる", kana: "アピア", dj: ["起きる", "文化", "意味", "～の上に"], de: ["apparent", "answer", "area", "happen"] },
            { en: "shoot", ja: "～を発射する、打ち上げる", kana: "シュート", dj: ["～を通して、～によって", "～を楽しみにする", "～を無駄にする", "～を移動する"], de: ["she's", "school", "sweet", "some"] },
            { en: "war", ja: "戦争", kana: "ウォー", dj: ["文化", "意味", "平和", "地震"], de: ["wow", "win", "watch", "waste"] },
            { en: "victim", ja: "犠牲者、被災者", kana: "ヴィクティム", dj: ["～に従う、守る", "ルール、規則", "～に位置する、ある", "正解、答え"], de: ["picnic", "until", "title", "lie"] },
            { en: "peace", ja: "平和", kana: "ピース", dj: ["文化", "意味", "戦争", "地震"], de: ["peacefully", "Peru", "phrase", "pray"] },
            { en: "earthquake", ja: "地震", kana: "アースクエイク", dj: ["文化", "意味", "戦争", "平和"], de: ["culture", "damage", "phrase", "each other"] },
            { en: "disaster", ja: "災害、天災", kana: "ディザスター", dj: ["正解、答え", "被害、損害", "ルール、規則", "～の上に"], de: ["damage", "answer", "phrase", "degree"] },
            { en: "damage", ja: "被害、損害", kana: "ダミッジ", dj: ["正解、答え", "災害、天災", "ルール、規則", "～の上に"], de: ["dome", "degree", "detail", "draw"] },
            { en: "great", ja: "大規模な、大きな", kana: "グレイト", dj: ["さまざまな、多種多様の", "不可能な", "色とりどりの、色彩豊かな", "曇りの"], de: ["ground", "read", "that", "area"] },
        ...
        sscerd1: {
          ...
          words: [
            { en: "parade", ja: "行進する、パレードする", kana: "パレイド", dj: ["演ずる、披露する", "～に参加する", "Aを上下さかさまにする", "～に加わる、参加する"], de: ["parent", "partner", "phrase", "painter"] },
            { en: "float", ja: "山車(だし)", kana: "フロート", dj: ["クライマックス", "明かりのついた", "ペルー[国名]", "クスコ[地名]"], de: ["flat", "flash", "food", "fan"] },
            ...
            { en: "lighted", ja: "明かりのついた", kana: "ライテッド", dj: ["クライマックス", "ペルー[国名]", "クスコ[地名]", "山車(だし)"], de: ["lie", "lantern", "lately", "love"] },
            { en: "human-shaped", ja: "人型の、人の形をした", kana: "ヒューマン シェイプト", dj: ["すばらしい、注目すべき", "平渓天燈節[祭り]", "インティ・ライミ[祭]", "クライマックス"], de: ["human", "happen", "harvest", "health"] },
            { en: "Taiwan", ja: "台湾", kana: "タイワン", dj: ["収穫", "海抜", "山車(だし)", "クライマックス"], de: ["town", "take", "title", "team"] },
            ...
            { en: "Peru", ja: "ペルー[国名]", kana: "ペルー", dj: ["クライマックス", "明かりのついた", "クスコ[地名]", "山車(だし)"], de: ["peace", "perform", "pray", "path"] },
            { en: "Inti Raymi", ja: "インティ・ライミ[祭]", kana: "インティ ライミ", dj: ["すばらしい、注目すべき", "人型の、人の形をした", "平渓天燈節[祭り]", "クライマックス"], de: ["into ~", "interview", "in total", "in ~"] },
            { en: "harvest", ja: "収穫", kana: "ハーベスト", dj: ["台湾", "海抜", "山車(だし)", "クライマックス"], de: ["hard", "haven't", "happen", "hasn't"] },
            ...
            { en: "above sea level", ja: "海抜", kana: "アバヴ シー レベル", dj: ["台湾", "収穫", "山車(だし)", "クライマックス"], de: ["above", "about ~", "absolutely", "about"] },
          ],
        },
      },
    },
      ...
      sets: {
        s1u7ckcu: {
          ...
          words: [
            ...
            { en: "pack", ja: "〜を荷造りする", kana: "パック", dj: ["〜を片づける", "〜をだます", "〜を感動させる", "〜を植え替える"], de: ["path", "plan", "peace", "trick"] },
            ...
            { en: "mirror", ja: "鏡", kana: "ミラー", dj: ["ちょうど", "髪を切る", "じっくりと", "次回(に)"], de: ["Miller", "million", "mission", "Mr."] },
        ...
        s12cthyx: {
          ...
          words: [
            ...
            { en: "never", ja: "1度も〜したことがない", kana: "ネバー", dj: ["〜に違いない", "痛い", "～することができない", "じょうずな、よい"], de: ["ever", "number", "river", "very"] },
            ...
            { en: "go-went-gone", ja: "行く[原形-過去形-過去分詞形]", kana: "ゴー・ウェント・ゴーン", dj: ["乗る[原形-過去形-過去分詞形]", "泳ぐ[原形-過去形-過去分詞形]", "[beの過去分詞形]", "眠る[原形-過去形]"], de: ["do-did-done", "good", "someone", "presentation"] },
        ...
        s290crj: {
          ...
          words: [
            ...
            { en: "someone", ja: "だれか", kana: "サムワン", dj: ["肖像画", "ドーム", "使い方", "世紀"], de: ["some", "so", "serve", "compose"] },
            ...
            { en: "lady", ja: "婦人", kana: "レディ", dj: ["世紀", "版画", "教会", "天井"], de: ["lately", "love", "low", "lie"] },
            { en: "dome", ja: "ドーム", kana: "ドーム", dj: ["だれか", "肖像画", "使い方", "世紀"], de: ["don't", "draw", "damage", "love"] },
            { en: "church", ja: "教会", kana: "チャーチ", dj: ["世紀", "版画", "婦人", "天井"], de: ["China", "Cusco", "comic", "century"] },
            ...
            { en: "usage", ja: "使い方", kana: "ユーセージ", dj: ["だれか", "肖像画", "ドーム", "世紀"], de: ["stage", "until", "peace", "cafe"] },
        ...
        s1kc1al7: {
          ...
          words: [
            ...
            { en: "known", ja: "〜を知っている[knowの過去分詞形]", kana: "ノウン", dj: ["吹き飛ばす[原形-過去形-過去分詞形]", "持っていく[原形-過去形-過去分詞形]", "～を投げる[原形-過去形-過去分詞形]", "〜をする[原形-過去形-過去分詞形]"], de: ["kill", "town", "now", "keep"] },
            ...
            { en: "lately", ja: "最近、この頃", kana: "レイトリー", dj: ["ますます〜に", "大多数(の)", "〜へ引っ越す", "〜で苦しむ"], de: ["lantern", "lady", "love", "lie"] },
            ...
            { en: "〜 or so", ja: "〜かそこら", kana: "オア ソー", dj: ["〜で苦しむ", "亡くなる", "ますます〜に", "大多数(の)"], de: ["on ~", "forest", "most", "A and B"] },
        ...
        s141neiu: {
          ...
          words: [
            ...
            { en: "half", ja: "30分", kana: "ハーフ", dj: ["向こうに", "回復", "けが", "人物の像"], de: ["hard", "hell", "happen", "high"] },
            { en: "figure", ja: "人物の像", kana: "フィギュア", dj: ["向こうに", "30分", "箱、ケース", "何千もの〜"], de: ["firework", "injury", "friend", "father"] },
            { en: "case", ja: "箱、ケース", kana: "ケース", dj: ["何千もの〜", "向こうに", "人物の像", "30分"], de: ["cafe", "call", "can", "class"] },
            { en: "apparent", ja: "明白な", kana: "アパレント", dj: ["可能な", "平らな", "無言の", "永久の"], de: ["appear", "ancient", "parent", "area"] },
        ...
        samlnth: {
          ...
          words: [
            ...
            { en: "Brazil", ja: "ブラジル[国名]", kana: "ブラジル", dj: ["約〜、およそ〜", "〜に投下される", "南東(の)", "一瞬にして"], de: ["bombing", "bud", "behind", "bamboo"] },
            { en: "aftereffect", ja: "後遺症", kana: "アフターエフェクト", dj: ["生存者", "非常に", "建物", "破壊"], de: ["America", "reflect", "street", "audience"] },
            ...
            { en: "complete", ja: "完全な", kana: "コンプリート", dj: ["無言の", "永久の", "記念の", "戦後の"], de: ["compose", "competition", "comic", "collect"] },
            ...
            { en: "around", ja: "約〜、およそ〜", kana: "アラウンド", dj: ["〜に投下される", "ブラジル[国名]", "南東(の)", "一瞬にして"], de: ["ground", "area", "art", "about"] },
        ...
        s1ret4z4: {
          ...
          words: [
            ...
            { en: "will", ja: "意志、決意", kana: "ウィル", dj: ["真実、事実", "使命、任務", "垂れ下がる", "燃えている"], de: ["win", "well", "hell", "wow"] },
            ...
            { en: "decrease", ja: "減少する", kana: "ディクリース", dj: ["爆発する", "〜に熱中する", "Aを上下さかさまにする", "～に感謝する"], de: ["decide", "degree", "destroy", "detail"] },
            ...
            { en: "storyteller", ja: "語り部", kana: "ストーリーテラー", dj: ["平和に", "終わる", "ぼろ切れ", "地獄"], de: ["street", "structure", "station", "study"] },
            ...
            { en: "flash", ja: "閃光", kana: "フラッシュ", dj: ["地獄", "工芸", "語り部", "肌"], de: ["flat", "float", "fan", "class"] },
            ...
            { en: "come to an end", ja: "終わる", kana: "カム トゥ アン エンド", dj: ["語り部", "平和に", "ぼろ切れ", "地獄"], de: ["continue ~ ing", "competition", "come-came-come", "compose"] },
