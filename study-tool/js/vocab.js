      ...
      sets: {
        u1p1: {
          ...
          words: [
            ...
            { en: "club", ja: "クラブ、部", kana: "クラブ", dj: ["私を（に）", "甘い菓子", "～もまた", "みなさん"], de: ["cloud", "clap", "class", "call"] },
            ...
            { en: "everyone", ja: "みなさん", kana: "エブリワン", dj: ["甘い菓子", "～もまた", "クラブ、部", "私を（に）"], de: ["ever", "explode", "effort", "end"] },
            { en: "South Africa", ja: "南アフリカ共和国", kana: "サウス アフリカ", dj: ["～が大好きである", "呼ぶ、名づける", "クラブ、部", "私を（に）"], de: ["southeast", "sound", "station", "surfing"] },
          ],
        },
        u1p2: {
          label: "Unit1 Part2",
          words: [
            ...
            { en: "fan", ja: "ファン", kana: "ファン", dj: ["いいえ", "しかし", "友達", "ラグビー"], de: ["face", "fox", "can", "father"] },
        ...
        u1p3: {
          ...
          words: [
            ...
            { en: "draw", ja: "（線や絵）をかく", kana: "ドロー", dj: ["（日本の）アニメ", "～に所属して", "芸術、美術", "～について"], de: ["drive", "driver", "date", "dome"] },
            { en: "swimming", ja: "水泳", kana: "スイミング", dj: ["学校", "授業", "今", "マンガ"], de: ["surfing", "saying", "sweet", "someone"] },
            ...
            { en: "so", ja: "だから", kana: "ソー", dj: ["マンガ", "うわあ", "水泳", "学校"], de: ["some", "sound", "see", "stop"] },
        ...
        s105gdqs: {
          ...
          words: [
            ...
            { en: "class", ja: "クラス", kana: "クラス", dj: ["チーム", "カナダ", "先生", "～の一員で"], de: ["clap", "cloud", "club", "case"] },
        ...
        s105gdqt: {
          ...
          words: [
            ...
            { en: "food", ja: "食べ物", kana: "フード", dj: ["読む", "そのこと", "中国", "親"], de: ["fox", "follow", "forest", "fan"] },
            { en: "father", ja: "父", kana: "ファーザァ", dj: ["親", "読む", "中国", "食べ物"], de: ["family", "face", "fan", "weather"] },
            { en: "some", ja: "いくつかの", kana: "サム", dj: ["中国の", "あれ、あの", "私たちの", "お気に入りの"], de: ["someone", "so", "sound", "see"] },
            { en: "Chinese", ja: "中国の", kana: "チャイニーズ", dj: ["いくつかの", "日本の", "英語の", "親切な"], de: ["China", "church", "compose", "curious"] },
        ...
        s105gdqu: {
          ...
          words: [
            ...
            { en: "it", ja: "それ[が]", kana: "イット", dj: ["歓迎される", "おっと", "鳥", "クラブ、部"], de: ["it's", "hit", "it'll", "itself"] },
            ...
            { en: "excuse", ja: "～を許す", kana: "イクスキューズ", dj: ["～を作る", "～を（注意して）見る", "～を利用する、～を受ける", "～を送る"], de: ["Excuse me.", "explode", "exit", "rescue"] },
            ...
            { en: "oops", ja: "おっと", kana: "ウプス", dj: ["それ[が]", "鳥", "歓迎される", "AとB"], de: ["oh", "hope", "rope", "often"] },
        ...
        s1spippr: {
          ...
          words: [
            ...
            { en: "family", ja: "一族、家族", kana: "ファミリィ", dj: ["だれ、だれが", "登場人物", "シンボル、象徴", "なぜ"], de: ["father", "fan", "favorite", "face"] },
            ...
            { en: "favorite", ja: "お気に入りの", kana: "フェイバリット", dj: ["勇かんな", "親切な", "１つの、1人の", "いくつかの"], de: ["family", "face", "father", "fan"] },
            ...
            { en: "symbol", ja: "シンボル、象徴", kana: "スィンボル", dj: ["だれ、だれが", "一族、家族", "～もまた、そのうえ", "登場人物"], de: ["system", "school", "skill", "smile"] },
            { en: "character", ja: "登場人物", kana: "キャラクタァ", dj: ["一族、家族", "だれ、だれが", "なぜ", "シンボル、象徴"], de: ["church", "career", "China", "craft"] },
            { en: "brave", ja: "勇かんな", kana: "ブレイヴ", dj: ["親切な", "お気に入りの", "私たちの", "日本の"], de: ["Brazil", "drive", "bird", "been"] },
            { en: "for ~", ja: "～に相当する", kana: "フォー", dj: ["～に感謝する", "勉強する", "練習する", "～に加わる、参加する"], de: ["forest", "from ~", "food", "fox"] },
          ],
        },
        s1spipps: {
          label: "Unit3 Our School Part2",
          words: [
            { en: "how", ja: "どのようにして", kana: "ハウ", dj: ["日本語、日本人", "住む、生きる", "放課後(に)", "する、行う"], de: ["hope", "hit", "here", "now"] },
        ...
        s1spippt: {
          ...
          words: [
            ...
            { en: "practice", ja: "練習する", kana: "プラクティス", dj: ["勉強する", "～に感謝する", "～に相当する", "～に加わる、参加する"], de: ["prayer", "pray", "produce", "pretty"] },
            { en: "go", ja: "行く", kana: "ゴウ", dj: ["勝つ", "1月", "2月", "3月"], de: ["good", "game", "glow", "no"] },
            { en: "station", ja: "駅", kana: "ステイション", dj: ["運", "勝つ", "行く", "1月"], de: ["stage", "start", "stop", "street"] },
            ...
            { en: "second", ja: "2番目(の)、2日", kana: "セカンド", dj: ["1番目(の)、1日", "3番目(の)、3日", "どこに[で、へ]", "～が見える、～を見る"], de: ["send", "see", "serve", "sound"] },
            { en: "third", ja: "3番目(の)、3日", kana: "サード", dj: ["1番目(の)、1日", "2番目(の)、2日", "どこに[で、へ]", "～が見える、～を見る"], de: ["that", "thank", "hard", "the"] },
            { en: "hard", ja: "一生懸命に", kana: "ハード", dj: ["～のそばに", "公園、遊園地", "試合、競技会", "10月"], de: ["half", "harvest", "habit", "here"] },
      ...
      sets: {
        u1p1: {
          ...
          words: [
            ...
            { en: "cloudy", ja: "曇りの", kana: "クラウディ", dj: ["西方の", "壮大な", "古代の", "必要な"], de: ["cloud", "closely", "club", "climax"] },
            ...
            { en: "step", ja: "ステップ、段階", kana: "ステップ", dj: ["摂氏～度（℃）", "（目標に）手が届く", "申し込む", "晴れた"], de: ["stop", "study", "stage", "start"] },
            { en: "low", ja: "最低値", kana: "ロー", dj: ["晴れた", "最高値", "激しく", "情報"], de: ["love", "loud", "lie", "lay"] },
            { en: "information", ja: "情報", kana: "インフォメーション", dj: ["天気", "動画", "晴れた", "最低値"], de: ["international", "interesting", "interview", "illustration"] },
            { en: "high", ja: "最高値", kana: "ハイ", dj: ["晴れた", "最低値", "激しく", "情報"], de: ["hit", "hard", "here", "hear"] },
            ...
            { en: "hard", ja: "激しく", kana: "ハード", dj: ["晴れた", "最低値", "最高値", "情報"], de: ["half", "harvest", "habit", "here"] },
            ...
            { en: "degree", ja: "摂氏～度（℃）", kana: "ディグリー", dj: ["ステップ、段階", "（目標に）手が届く", "申し込む", "晴れた"], de: ["decide", "detail", "decrease", "deer-deer"] },
        ...
        u1p2: {
          ...
          words: [
            { en: "be going to ~", ja: "～するつもり", kana: "ビー ゴーイング トゥ", dj: ["スキル、腕前", "パートナー、相棒", "～まで（ずっと）", "髪を切る"], de: ["be ready to ~", "be able to ~", "be coming soon", "be good at ~ing"] },
            ...
            { en: "end", ja: "終わり", kana: "エンド", dj: ["髪を切る", "～するつもり", "スキル、腕前", "パートナー、相棒"], de: ["ever", "exit", "bud", "no"] },
        ...
        u1p3: {
          ...
          words: [
            ...
            { en: "history", ja: "歴史", kana: "ヒストリー", dj: ["健康", "レシピ、調理法", "情報", "天気"], de: ["hit", "story", "high", "hallway"] },
            { en: "health", ja: "健康", kana: "ヘルス", dj: ["歴史", "レシピ、調理法", "情報", "天気"], de: ["hear", "heavy", "hell", "here"] },
            { en: "recipe", ja: "レシピ、調理法", kana: "レシピ", dj: ["歴史", "健康", "ステップ、段階", "摂氏～度（℃）"], de: ["recovery", "really", "rescue", "reach"] },
          ],
        },
        u1rt: {
          ...
          words: [
            ...
            { en: "be ready to ~", ja: "～する準備が整う", kana: "ビー レディ トゥ", dj: ["ミラー[人の姓]", "ミーティング、会議", "舞台、ステージ", "（クラスなどの）総代"], de: ["be able to ~", "be going to ~", "be into 〜", "be coming soon"] },
            { en: "look forward to ~", ja: "～を楽しみにする", kana: "ルック フォワード トゥ", dj: ["～を計画する", "～を提案する", "～を通して、～によって", "～を決める"], de: ["be ready to ~", "in order to ~", "come up with ~", "be going to ~"] },
            ...
            { en: "for the first time", ja: "初めて", kana: "フォー ザ ファースト タイム", dj: ["総計で", "参加者", "～できる", "題、演目"], de: ["at that time", "forest", "for ~", "forget-forgot"] },
            { en: "plan", ja: "～を計画する", kana: "プラン", dj: ["～を提案する", "～を決める", "～を楽しみにする", "～を通して、～によって"], de: ["plant", "play", "plum", "pray"] },
            ...
            { en: "president", ja: "（クラスなどの）総代", kana: "プレジデント", dj: ["AをBとともに終える", "ミーティング、会議", "～する準備が整う", "ミラー[人の姓]"], de: ["presentation", "print", "pretty", "produce"] },
            ...
            { en: "HS", ja: "High Schoolの略", kana: "エイチ エス", dj: ["Junior High Schoolの略", "they willの短縮形", "～を通して、～によって", "we willの短縮形"], de: ["JHS", "how", "hit", "he's"] },
            ...
            { en: "decide", ja: "～を決める", kana: "ディサイド", dj: ["～を計画する", "～を提案する", "～を楽しみにする", "～を通して、～によって"], de: ["divide", "December", "decrease", "degree"] },
        ...
        sdgerro: {
          ...
          words: [
            ...
            { en: "hope", ja: "～だとよいと思う、～を望む", kana: "ホウプ", dj: ["発表、プレゼン(テーション)", "コンビニエンスストア", "（試合など）に勝つ", "詳細、詳しい内容"], de: ["how", "here", "rose", "rope"] },
            ...
            { en: "station", ja: "駅", kana: "ステイション", dj: ["町", "通り", "バラ", "花火"], de: ["stage", "start", "street", "stop"] },
            ...
            { en: "rose", ja: "バラ", kana: "ロウズ", dj: ["通り", "花火", "町", "駅"], de: ["rope", "rule", "hope", "read"] },
            ...
            { en: "human", ja: "人間、人", kana: "ヒューマン", dj: ["ランタン", "～など", "点、小数点", "通り"], de: ["human-shaped", "hear", "hope", "habit"] },
            ...
            { en: "lantern", ja: "ランタン", kana: "ランタン", dj: ["人間、人", "～など", "点、小数点", "通り"], de: ["lately", "lady", "lay", "learn"] },
        ...
        sdgerrp: {
          ...
          words: [
            ...
            { en: "river", ja: "川", kana: "リバー", dj: ["森", "竹", "祈る", "地域"], de: ["driver", "relax", "rose", "rule"] },
            { en: "area", ja: "地域", kana: "エリア", dj: ["祈る", "日没", "祈り", "幸福"], de: ["art", "around", "also", "April"] },
            { en: "release", ja: "～を解放する", kana: "リリース", dj: ["～を無駄にする", "～を移動する", "～を招待する", "～を提出する"], de: ["relax", "repeat", "reflect", "rescue"] },
            ...
            { en: "happiness", ja: "幸福", kana: "ハピネス", dj: ["祈る", "地域", "日没", "祈り"], de: ["happen", "harvest", "habit", "Japanese"] },
        ...
        s1eufexn: {
          ...
          words: [
            ...
            { en: "rule", ja: "ルール、規則", kana: "ルール", dj: ["正解、答え", "～に従う、守る", "犠牲者、被災者", "災害、天災"], de: ["rugby", "rose", "rope", "read"] },
            { en: "culture", ja: "文化", kana: "カルチャー", dj: ["意味", "戦争", "平和", "地震"], de: ["cute", "century", "Cusco", "sculpture"] },
            { en: "lie", ja: "～に位置する、ある", kana: "ライ", dj: ["言い回し、フレーズ", "AにBを思い出させる", "～に従う、守る", "犠牲者、被災者"], de: ["live", "light", "low", "lay"] },
            ...
            { en: "various", ja: "さまざまな、多種多様の", kana: "ヴァリアス", dj: ["色とりどりの、色彩豊かな", "大規模な、大きな", "不可能な", "(自分)自身の、独自の"], de: ["curious", "victim", "very", "around"] },
            ...
            { en: "happen", ja: "起きる", kana: "ハプン", dj: ["現れる", "文化", "意味", "～の上に"], de: ["happiness", "harvest", "habit", "hard"] },
            { en: "follow", ja: "～に従う、守る", kana: "フォロウ", dj: ["犠牲者、被災者", "ルール、規則", "～に位置する、ある", "正解、答え"], de: ["food", "forest", "fox", "float"] },
            ...
            { en: "victim", ja: "犠牲者、被災者", kana: "ヴィクティム", dj: ["～に従う、守る", "ルール、規則", "～に位置する、ある", "正解、答え"], de: ["picnic", "system", "until", "title"] },
            ...
            { en: "disaster", ja: "災害、天災", kana: "ディザスター", dj: ["正解、答え", "被害、損害", "ルール、規則", "～の上に"], de: ["damage", "date", "divide", "December"] },
        ...
        sscerd1: {
          ...
          words: [
            ...
            { en: "climax", ja: "クライマックス", kana: "クライマックス", dj: ["明かりのついた", "ペルー[国名]", "クスコ[地名]", "山車(だし)"], de: ["class", "clear", "cloud", "club"] },
            ...
            { en: "Pingxi Sky Lantern Festival", ja: "平渓天燈節[祭り]", kana: "ピンシィ スカイ ランタン フェスティバル", dj: ["人型の、人の形をした", "クライマックス", "すばらしい、注目すべき", "明かりのついた"], de: ["one after another", "above sea level", "name A after B", "again and again"] },
            ...
            { en: "harvest", ja: "収穫", kana: "ハーベスト", dj: ["台湾", "海抜", "山車(だし)", "クライマックス"], de: ["hard", "haven't", "happen", "habit"] },
        ...
        s1wxob95: {
          ...
          words: [
            ...
            { en: "play", ja: "遊ぶ", kana: "プレイ", dj: ["情報", "メモ", "職業", "保育園"], de: ["plan", "plant", "plum", "pray"] },
            ...
            { en: "chopsticks", ja: "(食事用の)はし", kana: "チョップスティックス", dj: ["挿絵、イラスト", "下げ札、荷札", "色彩に富んだ", "職業体験日"], de: ["choose-chose", "church", "China", "crossing"] },
            ...
            { en: "colorful", ja: "色彩に富んだ", kana: "カラフル", dj: ["下げ札、荷札", "職業体験日", "挿絵、イラスト", "(食事用の)はし"], de: ["collect", "cool", "cloud", "comic"] },
          ],
        },
        s1ut4y6u: {
          ...
          words: [
            ...
            { en: "come out of ~", ja: "～から出てくる", kana: "カム アウト オブ", dj: ["イモムシ、毛虫", "(天体の)月", "(草木の)葉", "西洋スモモ、プラム"], de: ["come up", "come up with ~", "come to an end", "competition"] },
            { en: "come up", ja: "のぼる", kana: "カム アップ", dj: ["始める", "西洋ナシ", "光", "(天体の)月"], de: ["come up with ~", "come", "come out of ~", "comic"] },
            { en: "lie-lay", ja: "位置する、ある[原形-過去形]", kana: "ライ・レイ", dj: ["teach(教える)の過去形", "～を忘れる[原形-過去形]", "書く[原形-過去形]", "選ぶ[原形-過去形]"], de: ["lie", "light", "leaf", "lighted"] },
            { en: "plum", ja: "西洋スモモ、プラム", kana: "プラム", dj: ["～から出てくる", "イモムシ、毛虫", "(天体の)月", "(草木の)葉"], de: ["play", "plan", "pear", "plant"] },
            ...
            { en: "leaf", ja: "(草木の)葉", kana: "リーフ", dj: ["(天体の)月", "～から出てくる", "イモムシ、毛虫", "西洋ナシ"], de: ["learn", "lay", "pear", "lesson"] },
        ...
        s1ut4y6v: {
          ...
          words: [
            ...
            { en: "story", ja: "話、物語", kana: "ストーリィ", dj: ["ほほえむ", "学ぶ、習う", "これからは", "大きな声で"], de: ["stop", "study", "start", "storyteller"] },
            ...
            { en: "difficult", ja: "難しい", kana: "ディフィカルト", dj: ["お互い", "力強い", "重い", "ごく小さい"], de: ["divide", "disaster", "detail", "painful"] },
            { en: "Thank you for ~.", ja: "～をありがとう。", kana: "サンキュー フォー", dj: ["～を楽しみにする", "～を無駄にする", "～を移動する", "～を招待する"], de: ["Thank you.", "thank", "watch out for ~", "thousands of 〜"] },
            { en: "from now on", ja: "これからは", kana: "フロム ナウ オン", dj: ["学ぶ、習う", "大きな声で", "はっきりと", "話、物語"], de: ["from ~", "slow down", "friend", "~ and so on"] },
            { en: "smile", ja: "ほほえむ", kana: "スマイル", dj: ["話、物語", "学ぶ、習う", "これからは", "大きな声で"], de: ["skill", "stage", "serve", "story"] },
            { en: "clap", ja: "(手を)たたく、拍手する", kana: "クラップ", dj: ["理解する", "調節する", "行進する、パレードする", "演ずる、披露する"], de: ["class", "club", "clear", "cloud"] },
            ...
            { en: "loud", ja: "大きな声で", kana: "ラウド", dj: ["学ぶ、習う", "これからは", "はっきりと", "話、物語"], de: ["love", "low", "cloud", "live"] },
            { en: "clearly", ja: "はっきりと", kana: "クリアリィ", dj: ["学ぶ、習う", "これからは", "大きな声で", "話、物語"], de: ["clear", "closely", "class", "clap"] },
            { en: "Sincerely (yours)", ja: "[手紙の結びで]敬具", kana: "シンシアリィ ユアーズ", dj: ["うれしい、大喜びで", "スピード、速度", "何度も何度も", "学ぶ、習う"], de: ["since", "side by side", "suffer from 〜", "sign up"] },
    ...
    g3: {
      ...
      sets: {
        s1u7ckcu: {
          ...
          words: [
            { en: "do-did-done", ja: "〜をする[原形-過去形-過去分詞形]", kana: "ドゥー・ディド・ダン", dj: ["〜になる[原形-過去形-過去分詞形]", "持っていく[原形-過去形-過去分詞形]", "来る[原形-過去形-過去分詞形]", "～を襲う[原形-過去形-過去分詞形]"], de: ["go-went-gone", "dolphin", "dome", "decide"] },
            ...
            { en: "haven't", ja: "have notの短縮形", kana: "ハブント", dj: ["has notの短縮形", "we haveの短縮形", "I haveの短縮形", "will notの短縮形"], de: ["hasn't", "harvest", "happen", "habit"] },
            { en: "hasn't", ja: "has notの短縮形", kana: "ハズント", dj: ["we haveの短縮形", "I haveの短縮形", "have notの短縮形", "you areの短縮形"], de: ["haven't", "habit", "happen", "can't"] },
            { en: "trick", ja: "〜をだます", kana: "トリック", dj: ["〜を片づける", "〜を荷造りする", "〜を集める", "～を分ける"], de: ["truth", "pack", "thank", "third"] },
            ...
            { en: "closely", ja: "じっくりと", kana: "クロースリー", dj: ["次回(に)", "〜のすべて", "ちょうど", "髪を切る"], de: ["cloudy", "cloud", "clearly", "class"] },
            { en: "from now on", ja: "これからずっと、今後は", kana: "フロム ナウ オン", dj: ["[疑問文で]もう", "じっくりと", "次回(に)", "〜のすべて"], de: ["from ~", "slow down", "friend", "~ and so on"] },
            { en: "next time", ja: "次回(に)", kana: "ネクスト タイム", dj: ["じっくりと", "〜のすべて", "ちょうど", "髪を切る"], de: ["next", "near ~", "get here", "not ~"] },
            { en: "all of 〜", ja: "〜のすべて", kana: "オール オブ", dj: ["じっくりと", "次回(に)", "ちょうど", "髪を切る"], de: ["all day long", "also", "hear of 〜", "around ~"] },
            ...
            { en: "yet", ja: "[疑問文で]もう", kana: "イェット", dj: ["じっくりと", "これからずっと、今後は", "次回(に)", "〜のすべて"], de: ["but", "art", "see", "hit"] },
            { en: "clear", ja: "〜を片づける", kana: "クリア", dj: ["〜をだます", "〜を荷造りする", "〜を傷つける", "〜をする前に"], de: ["clearly", "clap", "class", "cloud"] },
            { en: "mirror", ja: "鏡", kana: "ミラー", dj: ["ちょうど", "髪を切る", "じっくりと", "次回(に)"], de: ["Miller", "million", "mission", "March"] },
            { en: "isn't 〜?", ja: "〜ではないですか。", kana: "イズント", dj: ["何回〜ですか。", "どうしたの。", "幸運を。", "彼は[が]～です。"], de: ["into ~", "in ~", "in total", "I see."] },
        ...
        s12cthyx: {
          ...
          words: [
            ...
            { en: "ever", ja: "今までに", kana: "エバー", dj: ["見てみる", "有名人", "テント", "サーフィン"], de: ["everyone", "never", "exit", "end"] },
            { en: "never", ja: "1度も〜したことがない", kana: "ネバー", dj: ["〜に違いない", "痛い", "～することができない", "じょうずな、よい"], de: ["next", "ever", "number", "note"] },
            { en: "How many times 〜?", ja: "何回〜ですか。", kana: "ハウ メニー タイムズ", dj: ["どうしたの。", "〜ではないですか。", "幸運を。", "はい、どうぞ。"], de: ["How about you ?", "How about ~?", "more and more 〜", "hand in ~"] },
            ...
            { en: "sleep-slept", ja: "眠る[原形-過去形]", kana: "スリープ・スレプト", dj: ["[beの過去分詞形]", "乗る[原形-過去形-過去分詞形]", "泳ぐ[原形-過去形-過去分詞形]", "行く[原形-過去形-過去分詞形]"], de: ["slowly", "street", "sunset", "silent"] },
            { en: "go-went-gone", ja: "行く[原形-過去形-過去分詞形]", kana: "ゴー・ウェント・ゴーン", dj: ["乗る[原形-過去形-過去分詞形]", "泳ぐ[原形-過去形-過去分詞形]", "[beの過去分詞形]", "眠る[原形-過去形]"], de: ["do-did-done", "grow-grew", "good", "someone"] },
            ...
            { en: "surfing", ja: "サーフィン", kana: "サーフィン", dj: ["今までに", "見てみる", "有名人", "テント"], de: ["survive", "survivor", "sunny", "saying"] },
        ...
        s12asurm: {
          ...
          words: [
            ...
            { en: "reflect", ja: "〜を映す、反射する", kana: "リフレクト", dj: ["〜を荷造りする", "〜を(次の世代へ)渡す", "〜を感動させる", "〜を切り抜けて生き残る"], de: ["repeat", "release", "really", "rescue"] },
            ...
            { en: "optical illusion", ja: "だまし絵", kana: "オプティカル イリュージョン", dj: ["ここに着く", "玄関ホール", "〜に夢中になる", "3Dアート美術館"], de: ["be coming soon", "3-D Art Museum", "continue ~ ing", "trompe l'oeil"] },
          ],
        },
        s290crj: {
          ...
          words: [
            ...
            { en: "someone", ja: "だれか", kana: "サムワン", dj: ["肖像画", "ドーム", "使い方", "世紀"], de: ["some", "sound", "so", "symbol"] },
            ...
            { en: "lady", ja: "婦人", kana: "レディ", dj: ["世紀", "版画", "教会", "天井"], de: ["lay", "lately", "love", "live"] },
            ...
            { en: "ceiling", ja: "天井", kana: "シーリング", dj: ["世紀", "版画", "婦人", "教会"], de: ["century", "crossing", "China", "meeting"] },
            { en: "Arcimboldo", ja: "アルチンボルド[人の姓]", kana: "アルチンボルド", dj: ["ポッツ[人の姓]", "だれか", "肖像画", "ドーム"], de: ["around", "area", "art", "anime"] },
            { en: "Spanish", ja: "スペイン(人)の", kana: "スパニッシュ", dj: ["フランス(人)の", "可能な", "平らな", "木造の、木製の"], de: ["speed", "station", "saying", "English"] },
            { en: "flat", ja: "平らな", kana: "フラット", dj: ["可能な", "スペイン(人)の", "フランス(人)の", "明白な"], de: ["flash", "float", "fan", "that"] },
            { en: "turn A upside down", ja: "Aを上下さかさまにする", kana: "ターン エー アップサイド ダウン", dj: ["(場所)に面する", "〜に熱中する", "爆発する", "減少する"], de: ["take part in ~", "take a look", "~ and so on", "Thank you for ~."] },
            ...
            { en: "photograph", ja: "写真", kana: "フォトグラフ", dj: ["世紀", "版画", "婦人", "教会"], de: ["phrase", "portrait", "program", "partner"] },
        ...
        s1kc1al7: {
          ...
          words: [
            ...
            { en: "ground", ja: "地面", kana: "グラウンド", dj: ["次の〜", "亡くなる", "それ自身", "〜で苦しむ"], de: ["around", "great", "sound", "good"] },
            { en: "most", ja: "大多数(の)", kana: "モースト", dj: ["ますます〜に", "最近、この頃", "〜へ引っ越す", "〜で苦しむ"], de: ["moon", "move", "month", "must"] },
            { en: "lately", ja: "最近、この頃", kana: "レイトリー", dj: ["ますます〜に", "大多数(の)", "〜へ引っ越す", "〜で苦しむ"], de: ["lantern", "lady", "lay", "love"] },
            ...
            { en: "be into 〜", ja: "〜に熱中する", kana: "ビー イントゥ", dj: ["爆発する", "減少する", "運転する", "(場所)に面する"], de: ["be going to ~", "be on fire", "be able to ~", "be ready to ~"] },
            { en: "move", ja: "〜を感動させる", kana: "ムーブ", dj: ["〜を傷つける", "〜をする前に", "〜を殺す", "〜を(次の世代へ)渡す"], de: ["most", "moon", "make", "move to 〜"] },
            { en: "before 〜ing", ja: "〜をする前に", kana: "ビフォー", dj: ["〜を傷つける", "〜を感動させる", "〜を殺す", "〜を(次の世代へ)渡す"], de: ["be on fire", "believe in ~", "be into 〜", "be able to ~"] },
            { en: "survive", ja: "〜を切り抜けて生き残る", kana: "サバイブ", dj: ["〜を(次の世代へ)渡す", "〜を感動させる", "〜を傷つける", "〜をする前に"], de: ["survivor", "surfing", "suggest", "serve"] },
            { en: "blow-blew-blown", ja: "吹き飛ばす[原形-過去形-過去分詞形]", kana: "ブロー・ブルー・ブローン", dj: ["〜を知っている[knowの過去分詞形]", "持っていく[原形-過去形-過去分詞形]", "～を投げる[原形-過去形-過去分詞形]", "〜をする[原形-過去形-過去分詞形]"], de: ["throw-threw-thrown", "grow-grew", "be able to ~", "choose-chose"] },
        ...
        s141neiu: {
          ...
          words: [
            { en: "collect", ja: "〜を集める", kana: "コレクト", dj: ["〜を保存する", "〜をだます", "～を分ける", "～を植える"], de: ["colorful", "compose", "complete", "comic"] },
            { en: "would", ja: "[willの過去形]", kana: "ウッド", dj: ["[beの過去分詞形]", "眠る[原形-過去形]", "～を育てる[原形-過去形]", "来る[原形-過去形-過去分詞形]"], de: ["won't", "wow", "wooden", "we'll"] },
            ...
            { en: "half", ja: "30分", kana: "ハーフ", dj: ["向こうに", "回復", "けが", "人物の像"], de: ["hard", "hallway", "habit", "hell"] },
            ...
            { en: "model A after B", ja: "BをモデルとしてAをつくる", kana: "モデル エー アフター ビー", dj: ["〜(が原因)で死ぬ", "〜の影響を受ける", "箱、ケース", "何千もの〜"], de: ["name A after B", "more and more 〜", "move to 〜", "end A with B"] },
            { en: "Good luck.", ja: "幸運を。", kana: "グッド ラック", dj: ["どうしたの。", "何回〜ですか。", "〜ではないですか。", "なるほど。"], de: ["good", "get here", "She is ~.", "He is ~."] },
        ...
        samlnth: {
          ...
          words: [
            { en: "explode", ja: "爆発する", kana: "エクスプロード", dj: ["減少する", "運転する", "〜に熱中する", "(場所)に面する"], de: ["excuse", "exit", "English", "everyone"] },
            ...
            { en: "southeast", ja: "南東(の)", kana: "サウスイースト", dj: ["一瞬にして", "原爆ドーム", "生存者", "後遺症"], de: ["South Africa", "sound", "someone", "success"] },
            ...
            { en: "Atomic Bomb Dome", ja: "原爆ドーム", kana: "アトミック ボム ドーム", dj: ["南東(の)", "一瞬にして", "生存者", "後遺症"], de: ["at that time", "from now on", "above sea level", "Arcimboldo"] },
            { en: "transplant", ja: "〜を植え替える", kana: "トランスプラント", dj: ["〜を荷造りする", "〜を感動させる", "〜を片づける", "〜を傷つける"], de: ["tragedy", "trick", "plant", "thousand"] },
        ...
        s1ret4z4: {
          ...
          words: [
            { en: "hit-hit-hit", ja: "～を襲う[原形-過去形-過去分詞形]", kana: "ヒット・ヒット・ヒット", dj: ["～を投げる[原形-過去形-過去分詞形]", "〜をする[原形-過去形-過去分詞形]", "〜になる[原形-過去形-過去分詞形]", "持っていく[原形-過去形-過去分詞形]"], de: ["hit", "history", "high", "health"] },
            ...
            { en: "throw-threw-thrown", ja: "～を投げる[原形-過去形-過去分詞形]", kana: "スロウ・スルー・スロウン", dj: ["～を襲う[原形-過去形-過去分詞形]", "持っていく[原形-過去形-過去分詞形]", "〜を知っている[knowの過去分詞形]", "吹き飛ばす[原形-過去形-過去分詞形]"], de: ["through", "blow-blew-blown", "take-took-taken", "grow-grew"] },
            ...
            { en: "repeat", ja: "～をくり返す", kana: "リピート", dj: ["～を破壊する", "～を焼く", "〜を片づける", "〜を傷つける"], de: ["release", "reflect", "rescue", "relax"] },
            { en: "destroy", ja: "～を破壊する", kana: "ディストロイ", dj: ["～をくり返す", "～を焼く", "〜を片づける", "〜を傷つける"], de: ["destruction", "destructive", "degree", "decide"] },
            { en: "decrease", ja: "減少する", kana: "ディクリース", dj: ["爆発する", "運転する", "〜に熱中する", "(場所)に面する"], de: ["December", "decide", "degree", "destroy"] },
            ...
            { en: "storyteller", ja: "語り部", kana: "ストーリーテラー", dj: ["平和に", "終わる", "ぼろ切れ", "地獄"], de: ["story", "street", "structure", "stop"] },
            { en: "skin", ja: "肌", kana: "スキン", dj: ["地獄", "閃光", "工芸", "語り部"], de: ["skill", "step", "stop", "see"] },
            ...
            { en: "the moment A, B", ja: "Aするとすぐ、Bした", kana: "ザ モーメント", dj: ["後継者、継承者", "～するために", "次から次へと", "意志、決意"], de: ["the following 〜", "thousands of 〜", "be coming soon", "be going to ~"] },
            { en: "hang down", ja: "垂れ下がる", kana: "ハング ダウン", dj: ["意志、決意", "真実、事実", "使命、任務", "燃えている"], de: ["hand in ~", "slow down", "happen", "hard"] },
            { en: "be on fire", ja: "燃えている", kana: "ビー オン ファイア", dj: ["意志、決意", "真実、事実", "使命、任務", "垂れ下がる"], de: ["be on your side", "be into 〜", "be going to ~", "be able to ~"] },
            { en: "come to an end", ja: "終わる", kana: "カム トゥ アン エンド", dj: ["語り部", "平和に", "ぼろ切れ", "地獄"], de: ["come out of ~", "come up with ~", "come up", "continue ~ ing"] },
            ...
            { en: "wooden", ja: "木造の、木製の", kana: "ウドゥン", dj: ["スペイン(人)の", "フランス(人)の", "破壊的な", "超音波の"], de: ["won't", "would", "wow", "western"] },
            { en: "craft", ja: "工芸", kana: "クラフト", dj: ["地獄", "閃光", "語り部", "肌"], de: ["cafe", "cross", "class", "call"] },
          ],
        },
        s144hajp: {
          label: "Unit3 Living Side by Side Part1",
          words: [
            { en: "hit", ja: "～にぶつかる", kana: "ヒット", dj: ["速度を落とす", "ゆっくりと", "私たち自身", "～に気をつける"], de: ["high", "how", "habit", "it"] },
            { en: "slowly", ja: "ゆっくりと", kana: "スロウリィ", dj: ["私たち自身", "～にぶつかる", "速度を落とす", "キツネ"], de: ["slow down", "story", "school", "Sunday"] },
            { en: "believe in ~", ja: "～を信頼する", kana: "ビリーヴ イン", dj: ["～を横断する", "〜を片づける", "〜を傷つける", "〜をする前に"], de: ["be able to ~", "before 〜ing", "be ready to ~", "be going to ~"] },
            { en: "drive", ja: "運転する", kana: "ドライヴ", dj: ["爆発する", "減少する", "〜に熱中する", "(場所)に面する"], de: ["driver", "draw", "date", "decide"] },
            { en: "cross", ja: "～を横断する", kana: "クロース", dj: ["～を信頼する", "〜を片づける", "〜を傷つける", "〜をする前に"], de: ["crossing", "craft", "class", "cloud"] },
            { en: "exit", ja: "出口", kana: "イグジット", dj: ["格言", "当時", "綱", "キツネ"], de: ["hit", "ever", "end", "it"] },
            { en: "saying", ja: "格言", kana: "セイイング", dj: ["出口", "当時", "綱", "キツネ"], de: ["surfing", "skin", "second", "slowly"] },
            { en: "rope", ja: "綱", kana: "ロープ", dj: ["雲", "出口", "格言", "当時"], de: ["rose", "rule", "hope", "read"] },
            { en: "fox", ja: "キツネ", kana: "フォックス", dj: ["運転手", "出口", "格言", "当時"], de: ["food", "fan", "forest", "follow"] },
            { en: "driver", ja: "運転手", kana: "ドライバー", dj: ["キツネ", "出口", "格言", "当時"], de: ["drive", "river", "draw", "degree"] },
            { en: "deer-deer", ja: "シカ[単数形・複数形]", kana: "ディア・ディア", dj: ["並んで、助け合って", "あなたの味方である", "～に気をつける", "間もなく(だ)"], de: ["degree", "December", "driver", "decrease"] },
            { en: "cloud", ja: "雲", kana: "クラウド", dj: ["綱", "出口", "格言", "当時"], de: ["cloudy", "club", "closely", "class"] },
            { en: "ourselves", ja: "私たち自身", kana: "アーセルヴズ", dj: ["ゆっくりと", "～にぶつかる", "速度を落とす", "キツネ"], de: ["our", "driver", "serve", "October"] },
            { en: "watch out for ~", ja: "～に気をつける", kana: "ウォッチ アウト フォー", dj: ["間もなく(だ)", "～にぶつかる", "速度を落とす", "ゆっくりと"], de: ["watch", "want to ~", "come out of ~", "Thank you for ~."] },
            { en: "at that time", ja: "当時", kana: "アット ザット タイム", dj: ["出口", "格言", "綱", "キツネ"], de: ["next time", "Atomic Bomb Dome", "all day long", "A and B"] },
            { en: "slow down", ja: "速度を落とす", kana: "スロー ダウン", dj: ["～にぶつかる", "ゆっくりと", "私たち自身", "～に気をつける"], de: ["slowly", "hang down", "sign up", "station"] },
            { en: "side by side", ja: "並んで、助け合って", kana: "サイド バイ サイド", dj: ["あなたの味方である", "シカ[単数形・複数形]", "～に気をつける", "間もなく(だ)"], de: ["sign up", "be on fire", "She is ~.", "slow down"] },
            { en: "be on your side", ja: "あなたの味方である", kana: "ビー オン ユア サイド", dj: ["並んで、助け合って", "シカ[単数形・複数形]", "～に気をつける", "間もなく(だ)"], de: ["be on fire", "be coming soon", "be good at ~ing", "be going to ~"] },
            { en: "be coming soon", ja: "間もなく(だ)", kana: "ビー カミング スーン", dj: ["～に気をつける", "～にぶつかる", "速度を落とす", "ゆっくりと"], de: ["be going to ~", "be on fire", "be ready to ~", "be on your side"] },
          ],
        },
        s144hajq: {
          label: "Unit3 Living Side by Side Part2",
          words: [
            { en: "produce", ja: "作り出す", kana: "プロデュース", dj: ["システム", "停留所", "機器、装置", "音波"], de: ["program", "practice", "prayer", "print"] },
            { en: "keep A away from B", ja: "AをBから遠ざける", kana: "キープ エー アウェイ フロム ビー", dj: ["鉄道、鉄道路線", "機器、装置", "作り出す", "システム"], de: ["model A after B", "name A after B", "be ready to ~", "remind A of B"] },
            { en: "system", ja: "システム", kana: "システム", dj: ["作り出す", "停留所", "機器、装置", "音波"], de: ["symbol", "step", "stop", "street"] },
            { en: "sound", ja: "音波", kana: "サウンド", dj: ["踏切", "停留所", "作り出す", "システム"], de: ["so", "some", "someone", "sunny"] },
            { en: "stop", ja: "停留所", kana: "ストップ", dj: ["作り出す", "システム", "音波", "踏切"], de: ["story", "step", "study", "stage"] },
            { en: "railroad", ja: "鉄道、鉄道路線", kana: "レイルロード", dj: ["AをBから遠ざける", "機器、装置", "作り出す", "システム"], de: ["rag", "relax", "read", "really"] },
            { en: "equipment", ja: "機器、装置", kana: "イクウィプメント", dj: ["作り出す", "システム", "停留所", "鉄道、鉄道路線"], de: ["exit", "everyone", "effort", "president"] },
            { en: "crossing", ja: "踏切", kana: "クロッシング", dj: ["音波", "停留所", "作り出す", "システム"], de: ["cross", "ceiling", "craft", "closely"] },
            { en: "ultrasonic", ja: "超音波の", kana: "ウルトラソニック", dj: ["破壊的な", "可能な", "平らな", "明白な"], de: ["until", "lesson", "understand", "usage"] },
            { en: "come up with ~", ja: "～を思いつく", kana: "カム アップ ウィズ", dj: ["〜を片づける", "〜を傷つける", "〜をする前に", "〜を保存する"], de: ["come up", "come out of ~", "come to an end", "competition"] },
          ],
        },
        s1kzn1f0: {
          label: "Unit3 Living Side by Side Part3・L&T・T&S",
          words: [
            { en: "grow-grew", ja: "～を育てる[原形-過去形]", kana: "グロウ・グルー", dj: ["来る[原形-過去形-過去分詞形]", "[beの過去分詞形]", "乗る[原形-過去形-過去分詞形]", "泳ぐ[原形-過去形-過去分詞形]"], de: ["ground", "gradually", "program", "great"] },
            { en: "prevent A from ~ing", ja: "Aが～するのを妨げる", kana: "プリベント エー フロム イング", dj: ["だんだんと、次第に", "計画、プログラム", "BにちなんでAを名づける", "(卵を)産む"], de: ["presentation", "remind A of B", "be good at ~ing", "suffer from 〜"] },
            { en: "What's the matter?", ja: "どうしたの。", kana: "ワッツ ザ マター", dj: ["何回〜ですか。", "幸運を。", "〜ではないですか。", "すみません。"], de: ["what's", "what're", "what", "name A after B"] },
            { en: "lay", ja: "(卵を)産む", kana: "レイ", dj: ["～する好機", "取り組み", "計画、プログラム", "癖、習慣"], de: ["lady", "lately", "low", "lie"] },
            { en: "divide", ja: "～を分ける", kana: "ディバイド", dj: ["～を植える", "～を救出する", "〜をだます", "〜を集める"], de: ["decide", "drive", "invite", "disaster"] },
            { en: "effort", ja: "取り組み", kana: "エフォート", dj: ["癖、習慣", "1日中", "～する好機", "イルカ"], de: ["ever", "exit", "float", "end"] },
            { en: "all day long", ja: "1日中", kana: "オール デイ ロング", dj: ["イルカ", "取り組み", "癖、習慣", "～する好機"], de: ["all of 〜", "take a look", "at that time", "A and B"] },
            { en: "an opportunity to ~", ja: "～する好機", kana: "アン オポチュニティ トゥ", dj: ["(卵を)産む", "取り組み", "癖、習慣", "1日中"], de: ["in order to ~", "be going to ~", "be ready to ~", "at that time"] },
            { en: "rescue", ja: "～を救出する", kana: "レスキュー", dj: ["～を分ける", "～を植える", "〜を片づける", "〜を傷つける"], de: ["recipe", "repeat", "reach", "release"] },
            { en: "face", ja: "(場所)に面する", kana: "フェイス", dj: ["〜に熱中する", "Aを上下さかさまにする", "爆発する", "減少する"], de: ["fan", "father", "family", "food"] },
            { en: "program", ja: "計画、プログラム", kana: "プログラム", dj: ["だんだんと、次第に", "Aが～するのを妨げる", "(卵を)産む", "～する好機"], de: ["produce", "pray", "prayer", "print"] },
            { en: "dolphin", ja: "イルカ", kana: "ダルフィン", dj: ["1日中", "取り組み", "癖、習慣", "～する好機"], de: ["dome", "do", "don't", "detail"] },
            { en: "habit", ja: "癖、習慣", kana: "ハビット", dj: ["取り組み", "1日中", "～する好機", "イルカ"], de: ["hard", "half", "hit", "happen"] },
            { en: "plant", ja: "～を植える", kana: "プラント", dj: ["～を分ける", "～を救出する", "〜をだます", "〜を集める"], de: ["plan", "play", "plum", "point"] },
            { en: "curious", ja: "好奇心の強い、奇妙な", kana: "キュリアス", dj: ["スペイン(人)の", "フランス(人)の", "木造の、木製の", "破壊的な"], de: ["various", "Cusco", "cross", "culture"] },
            { en: "gradually", ja: "だんだんと、次第に", kana: "グラジュアリィ", dj: ["Aが～するのを妨げる", "計画、プログラム", "(卵を)産む", "BにちなんでAを名づける"], de: ["ground", "grow-grew", "really", "great"] },
            { en: "name A after B", ja: "BにちなんでAを名づける", kana: "ネーム エー アフター ビー", dj: ["Aが～するのを妨げる", "だんだんと、次第に", "計画、プログラム", "(卵を)産む"], de: ["model A after B", "end A with B", "near ~", "after ~"] },
          ],
        },
      },
    },
